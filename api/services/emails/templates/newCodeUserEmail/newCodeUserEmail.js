...
const newCodeUserMail = data => {
	...
	const emailTemplate = path.join(__dirname, "./newCodeUserEmail.html");
	...
	return {
		...
		text: "Te hemos generado un nuevo código de confirmación, Haz click en el boton para activar la cuenta:",
		html: htmlToSend,
		attachments: [
			{
